...
SANDBOX_LLM_BASE_URL="${SANDBOX_LLM_BASE_URL:-http://172.17.0.1:${MANUAL_LLM_PORT}/v1}"
...
Press Ctrl-C in this terminal to stop the sandbox and both background services.
