...
- [agent-integration-notes.md](../../docs/agent-integration-notes.md) for the more general checkpoint/restore lessons that came out of the Claude integration work.
...
This fix is documented more generally in [agent-integration-notes.md](../../docs/agent-integration-notes.md).
